...
local bBuffFlags = {
    ...
    attributes = {
        radiant = true, -- Set to 'false' to disable Radiant bots receiving an Attribute boost.
        dire    = true, -- Set to 'false' to disable Dire bots receiving an Attribute boost.
    },
}
